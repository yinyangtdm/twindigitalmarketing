...
const QUESTIONS = [
  ...
  { id: "website", label: "What is your current website URL?", type: "text", placeholder: "https://yourwebsite.com" },
  {
    id: "domain",
    label: "If you do not already have a domain, would you like help finding one?",
    type: "choice",
    options: ["Yes, I'd like help", "No, I already have one", "No, I will obtain my own hosting"],
  },
  {
    id: "help",
    label: "What do you need help with?",
    type: "multiselect",
    options: ["New website", "Website redesign", "Landing page", "Conversion optimization", "Ongoing website support", "Social media marketing", "Not sure yet"],
  },
  { id: "mission", label: "Company Mission", description: "In one or two sentences, what does your company do?", type: "textarea", placeholder: "We help businesses..." },
  {
    ...
    description: "What is the main goal of this website?",
    type: "choice",
    options: ["Generate leads", "Sell products", "Provide information", "Build brand awareness", "Other"],
  },
  ...
  { id: "assets", label: "Visual Assets", description: "Do you have existing branding, a style guide, or high-quality photography ready to use?", type: "textarea", placeholder: "Yes, we have a logo and brand guidelines..." },
  {
    ...
    description: "Select all essential features you need for your website.",
    type: "multiselect",
    options: [
      "Contact forms",
      "Blog",
  ...
  { id: "other", label: "Is there anything else you'd like to share before we get started?", description: "Feel free to include any questions or details we haven't covered.", type: "textarea", placeholder: "..." },
];
